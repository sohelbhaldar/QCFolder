...
import { CodeReviewCheckPointsComponent } from './QcSheet/CheckPoints/code-review-check-points/code-review-check-points.component';
import { CodeReviewTabComponent } from './QcSheet/QCTab/code-review-tab/code-review-tab.component';
...
@NgModule({
  declarations: [
    ...
    CodeReviewCheckPointsComponent,
    CodeReviewTabComponent,
