...
@Component({
  selector: 'app-code-review-check-points',
  templateUrl: './code-review-check-points.component.html',
  styleUrls: ['./code-review-check-points.component.css']
})
export class CodeReviewCheckPointsComponent implements OnInit {
...
// }
constructor (private renderer: Renderer2,private service : CodeReviewService, private _messageService: FunctionCallerService ,public dialog: MatDialog)
  {
    /////////////////////////////////////////////// Initial QC/////////////////////////////////////////////////////////////
  ...
  openDialogPleaseEnterAllCheckPoints(CheckPointNum,CheckPointData): void {
    debugger;
