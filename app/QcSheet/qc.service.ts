...
import { WINDOW } from './QCTab/qc-tab/windows-provider';
...
export class QCService {
  ...
  selectedRadio = null;
  username = "";
  // readonly rootURL = ' http://BLRLW9050/QCAPIServer/api';
   //readonly rootURL = ' http://cso-scale-intv/QCAPIServer/api';
...
public CheckPoints() {
  ...
  return this.http.get(this.rootURL + '/CheckPoints/LoadCheckPoints', requestOptions);
}
